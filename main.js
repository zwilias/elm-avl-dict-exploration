...
var _BrianHicks$elm_benchmark$Benchmark_LowLevel$sample = _BrianHicks$elm_benchmark$Native_Benchmark.sample;
var _BrianHicks$elm_benchmark$Benchmark_LowLevel$operation8 = _BrianHicks$elm_benchmark$Native_Benchmark.operation8;
var _BrianHicks$elm_benchmark$Benchmark_LowLevel$operation7 = _BrianHicks$elm_benchmark$Native_Benchmark.operation7;
var _BrianHicks$elm_benchmark$Benchmark_LowLevel$operation6 = _BrianHicks$elm_benchmark$Native_Benchmark.operation6;
var _BrianHicks$elm_benchmark$Benchmark_LowLevel$operation5 = _BrianHicks$elm_benchmark$Native_Benchmark.operation5;
var _BrianHicks$elm_benchmark$Benchmark_LowLevel$operation4 = _BrianHicks$elm_benchmark$Native_Benchmark.operation4;
var _BrianHicks$elm_benchmark$Benchmark_LowLevel$operation3 = _BrianHicks$elm_benchmark$Native_Benchmark.operation3;
var _BrianHicks$elm_benchmark$Benchmark_LowLevel$operation2 = _BrianHicks$elm_benchmark$Native_Benchmark.operation2;
var _BrianHicks$elm_benchmark$Benchmark_LowLevel$operation1 = _BrianHicks$elm_benchmark$Native_Benchmark.operation1;
var _BrianHicks$elm_benchmark$Benchmark_LowLevel$operation = _BrianHicks$elm_benchmark$Native_Benchmark.operation;
var _BrianHicks$elm_benchmark$Benchmark_LowLevel$UnknownError = function (a) {
	return {ctor: 'UnknownError', _0: a};
};
var _BrianHicks$elm_benchmark$Benchmark_LowLevel$StackOverflow = {ctor: 'StackOverflow'};
var _BrianHicks$elm_benchmark$Benchmark_LowLevel$Operation = {ctor: 'Operation'};

var _BrianHicks$elm_benchmark$Benchmark_Internal$Compare = F3(
	function (a, b, c) {
		return {ctor: 'Compare', _0: a, _1: b, _2: c};
	});
var _BrianHicks$elm_benchmark$Benchmark_Internal$Group = F2(
	function (a, b) {
		return {ctor: 'Group', _0: a, _1: b};
	});
var _BrianHicks$elm_benchmark$Benchmark_Internal$Benchmark = F3(
	function (a, b, c) {
		return {ctor: 'Benchmark', _0: a, _1: b, _2: c};
	});
var _BrianHicks$elm_benchmark$Benchmark_Internal$Success = function (a) {
	return {ctor: 'Success', _0: a};
};
var _BrianHicks$elm_benchmark$Benchmark_Internal$Failure = function (a) {
	return {ctor: 'Failure', _0: a};
};
var _BrianHicks$elm_benchmark$Benchmark_Internal$Pending = F3(
	function (a, b, c) {
		return {ctor: 'Pending', _0: a, _1: b, _2: c};
	});
var _BrianHicks$elm_benchmark$Benchmark_Internal$ToSize = function (a) {
	return {ctor: 'ToSize', _0: a};
};
var _BrianHicks$elm_benchmark$Benchmark_Internal$benchmark = F2(
	function (name, operation) {
		return A3(
			_BrianHicks$elm_benchmark$Benchmark_Internal$Benchmark,
			name,
			operation,
			_BrianHicks$elm_benchmark$Benchmark_Internal$ToSize(5 * _elm_lang$core$Time$second));
	});

var _BrianHicks$elm_benchmark$Benchmark$standardizeSampleSize = function (sampleSize) {
	var helper = F2(
		function (rough, magnitude) {
			helper:
			while (true) {
				if (_elm_lang$core$Native_Utils.cmp(rough, 10) > 0) {
					var _v0 = _elm_lang$core$Basics$round(
						_elm_lang$core$Basics$toFloat(rough) / 10),
						_v1 = magnitude * 10;
					rough = _v0;
					magnitude = _v1;
					continue helper;
...
var _BrianHicks$elm_benchmark$Benchmark$findSampleSize = function (operation) {
	var minimumRuntime = 100 * _elm_lang$core$Time$millisecond;
	var resample = F2(
		function (size, total) {
			return (_elm_lang$core$Native_Utils.cmp(total, minimumRuntime) < 0) ? sample(size * 10) : _elm_lang$core$Task$succeed(
				total / _elm_lang$core$Basics$toFloat(size));
		});
	var sample = function (size) {
		return A2(
			_elm_lang$core$Task$andThen,
			resample(size),
			A2(_BrianHicks$elm_benchmark$Benchmark_LowLevel$sample, size, operation));
	};
	...
	return A2(
		_elm_lang$core$Task$map,
		fit,
		sample(initialSampleSize));
};
var _BrianHicks$elm_benchmark$Benchmark$step = function (benchmark) {
	var _p0 = benchmark;
	switch (_p0.ctor) {
		case 'Benchmark':
			var _p9 = _p0._1;
							...
							function (_p2) {
								return _elm_lang$core$Task$succeed(
									A3(
										...
										_p8,
										_p9,
										_BrianHicks$elm_benchmark$Benchmark_Internal$Failure(_p2)));
							},
							A2(
								_elm_lang$core$Task$map,
								A2(_BrianHicks$elm_benchmark$Benchmark_Internal$Benchmark, _p8, _p9),
								A2(
									_elm_lang$core$Task$map,
									function (sampleSize) {
										return A3(
											_BrianHicks$elm_benchmark$Benchmark_Internal$Pending,
											_p1._0,
											sampleSize,
											{ctor: '[]'});
									},
									A2(
										_elm_lang$core$Task$map,
										_BrianHicks$elm_benchmark$Benchmark$standardizeSampleSize,
										_BrianHicks$elm_benchmark$Benchmark$findSampleSize(_p9))))));
				case 'Pending':
					var _p7 = _p1._0;
					var _p6 = _p1._2;
					var _p5 = _p1._1;
					return (_elm_lang$core$Native_Utils.cmp(
						_elm_lang$core$List$sum(_p6),
						_p7) < 0) ? _elm_lang$core$Maybe$Just(
						A2(
							_elm_lang$core$Task$onError,
							function (_p3) {
								return _elm_lang$core$Task$succeed(
									A3(
										...
										_p8,
										_p9,
										_BrianHicks$elm_benchmark$Benchmark_Internal$Failure(_p3)));
							},
							A2(
								_elm_lang$core$Task$map,
								function (_p4) {
								...
								A2(_BrianHicks$elm_benchmark$Benchmark_LowLevel$sample, _p5, _p9)))) : _elm_lang$core$Maybe$Just(
						_elm_lang$core$Task$succeed(
							A3(
								_BrianHicks$elm_benchmark$Benchmark_Internal$Benchmark,
								_p8,
								_p9,
								_BrianHicks$elm_benchmark$Benchmark_Internal$Success(
		...
		case 'Group':
			...
			var tasks = A2(_elm_lang$core$List$map, _BrianHicks$elm_benchmark$Benchmark$step, _p10);
			return A2(_elm_lang$core$List$all, isNothing, tasks) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(
				A2(
					_elm_lang$core$Task$map,
					_BrianHicks$elm_benchmark$Benchmark_Internal$Group(_p0._0),
					_elm_lang$core$Task$sequence(
						A3(
							_elm_lang$core$List$map2,
							F2(
								function (benchmark, task) {
									return A2(
										...
										_elm_lang$core$Task$succeed(benchmark),
										task);
								}),
							_p10,
							tasks))));
		default:
			...
			var _p11 = {
				ctor: '_Tuple2',
				_0: _BrianHicks$elm_benchmark$Benchmark$step(_p12),
				_1: _BrianHicks$elm_benchmark$Benchmark$step(_p13)
			};
			if ((_p11._0.ctor === 'Nothing') && (_p11._1.ctor === 'Nothing')) {
				return _elm_lang$core$Maybe$Nothing;
			} else {
				return _elm_lang$core$Maybe$Just(
					A3(
						_elm_lang$core$Task$map2,
						_BrianHicks$elm_benchmark$Benchmark_Internal$Compare(_p0._0),
						A2(
							_elm_lang$core$Maybe$withDefault,
							_elm_lang$core$Task$succeed(_p12),
							_p11._0),
						A2(
							_elm_lang$core$Maybe$withDefault,
							_elm_lang$core$Task$succeed(_p13),
							_p11._1)));
			}
	}
};
var _BrianHicks$elm_benchmark$Benchmark$compare = _BrianHicks$elm_benchmark$Benchmark_Internal$Compare;
var _BrianHicks$elm_benchmark$Benchmark$benchmark8 = function (name) {
	return function (fn) {
		return function (a) {
			return function (b) {
				return function (c) {
								...
								return function (g) {
									return function (h) {
										return A2(
											_BrianHicks$elm_benchmark$Benchmark_Internal$benchmark,
											name,
											A9(_BrianHicks$elm_benchmark$Benchmark_LowLevel$operation8, fn, a, b, c, d, e, f, g, h));
									};
								};
							};
						};
...
var _BrianHicks$elm_benchmark$Benchmark$benchmark7 = F9(
	function (name, fn, a, b, c, d, e, f, g) {
		return A2(
			_BrianHicks$elm_benchmark$Benchmark_Internal$benchmark,
			name,
			A8(_BrianHicks$elm_benchmark$Benchmark_LowLevel$operation7, fn, a, b, c, d, e, f, g));
	});
var _BrianHicks$elm_benchmark$Benchmark$benchmark6 = F8(
	function (name, fn, a, b, c, d, e, f) {
		return A2(
			_BrianHicks$elm_benchmark$Benchmark_Internal$benchmark,
			name,
			A7(_BrianHicks$elm_benchmark$Benchmark_LowLevel$operation6, fn, a, b, c, d, e, f));
	});
var _BrianHicks$elm_benchmark$Benchmark$benchmark5 = F7(
	function (name, fn, a, b, c, d, e) {
		return A2(
			_BrianHicks$elm_benchmark$Benchmark_Internal$benchmark,
			name,
			A6(_BrianHicks$elm_benchmark$Benchmark_LowLevel$operation5, fn, a, b, c, d, e));
	});
var _BrianHicks$elm_benchmark$Benchmark$benchmark4 = F6(
	function (name, fn, a, b, c, d) {
		return A2(
			_BrianHicks$elm_benchmark$Benchmark_Internal$benchmark,
			name,
			A5(_BrianHicks$elm_benchmark$Benchmark_LowLevel$operation4, fn, a, b, c, d));
	});
var _BrianHicks$elm_benchmark$Benchmark$benchmark3 = F5(
	function (name, fn, a, b, c) {
		return A2(
			_BrianHicks$elm_benchmark$Benchmark_Internal$benchmark,
			name,
			A4(_BrianHicks$elm_benchmark$Benchmark_LowLevel$operation3, fn, a, b, c));
	});
var _BrianHicks$elm_benchmark$Benchmark$benchmark2 = F4(
	function (name, fn, a, b) {
		return A2(
			_BrianHicks$elm_benchmark$Benchmark_Internal$benchmark,
			name,
			A3(_BrianHicks$elm_benchmark$Benchmark_LowLevel$operation2, fn, a, b));
	});
var _BrianHicks$elm_benchmark$Benchmark$benchmark1 = F3(
	function (name, fn, a) {
		return A2(
			_BrianHicks$elm_benchmark$Benchmark_Internal$benchmark,
			name,
			A2(_BrianHicks$elm_benchmark$Benchmark_LowLevel$operation1, fn, a));
	});
var _BrianHicks$elm_benchmark$Benchmark$benchmark = F2(
	function (name, fn) {
		return A2(
			_BrianHicks$elm_benchmark$Benchmark_Internal$benchmark,
			name,
			_BrianHicks$elm_benchmark$Benchmark_LowLevel$operation(fn));
	});
var _BrianHicks$elm_benchmark$Benchmark$describe = _BrianHicks$elm_benchmark$Benchmark_Internal$Group;
var _BrianHicks$elm_benchmark$Benchmark$withRuntime = F2(
		...
		switch (_p14.ctor) {
			case 'Benchmark':
				return A3(
					...
					_p14._0,
					_p14._1,
					_BrianHicks$elm_benchmark$Benchmark_Internal$ToSize(time));
			case 'Group':
				return A2(
					_BrianHicks$elm_benchmark$Benchmark_Internal$Group,
					_p14._0,
					A2(
						_elm_lang$core$List$map,
						_BrianHicks$elm_benchmark$Benchmark$withRuntime(time),
						_p14._1));
			default:
				return A3(
					_BrianHicks$elm_benchmark$Benchmark_Internal$Compare,
					_p14._0,
					A2(_BrianHicks$elm_benchmark$Benchmark$withRuntime, time, _p14._1),
					A2(_BrianHicks$elm_benchmark$Benchmark$withRuntime, time, _p14._2));
		}
	});
...
var _BrianHicks$elm_benchmark$Benchmark_Reporting$encoder = function (report) {
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: '_stage',
							_1: _elm_lang$core$Json_Encode$string('toSize')
						},
						_1: {
							ctor: '::',
							_0: {
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: '_stage',
							_1: _elm_lang$core$Json_Encode$string('pending')
						},
						_1: {
							ctor: '::',
							_0: {
								...
								_1: {
									...
									_0: {
										...
										_1: _elm_lang$core$Json_Encode$list(
											A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$float, _p0._2))
									},
									_1: {ctor: '[]'}
								}
							}
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: '_stage',
							_1: _elm_lang$core$Json_Encode$string('failure')
						},
						_1: {
							ctor: '::',
							_0: function () {
								var _p1 = _p0._0;
								if (_p1.ctor === 'StackOverflow') {
									return {
										ctor: '_Tuple2',
										_0: 'message',
										_1: _elm_lang$core$Json_Encode$string('stack overflow')
									};
								} else {
									return {
										ctor: '_Tuple2',
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: '_stage',
							_1: _elm_lang$core$Json_Encode$string('success')
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'sampleSize',
								_1: _elm_lang$core$Json_Encode$int(_p2.sampleSize)
							},
							_1: {
								ctor: '::',
								_0: {
									...
									_0: 'samples',
									_1: _elm_lang$core$Json_Encode$list(
										A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$float, _p2.samples))
								},
								_1: {ctor: '[]'}
							}
						}
	...
	var encodeReport = function (report) {
		var _p3 = report;
		switch (_p3.ctor) {
			case 'Benchmark':
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: '_kind',
							_1: _elm_lang$core$Json_Encode$string('benchmark')
						},
						_1: {
							ctor: '::',
							_0: {
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: '_kind',
							_1: _elm_lang$core$Json_Encode$string('compare')
						},
						_1: {
							ctor: '::',
							_0: {
				...
				return _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: '_kind',
							_1: _elm_lang$core$Json_Encode$string('group')
						},
						_1: {
							ctor: '::',
							_0: {
							...
							_1: {
								...
								_0: {
									...
									_0: 'benchmarks',
									_1: _elm_lang$core$Json_Encode$list(
										A2(_elm_lang$core$List$map, encodeReport, _p3._1))
								},
								_1: {ctor: '[]'}
							}
						}
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_1: {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'report',
					_1: encodeReport(report)
				},
				_1: {ctor: '[]'}
			}
		});
};
var _BrianHicks$elm_benchmark$Benchmark_Reporting$totalRuntime = function (stats) {
	return _elm_lang$core$List$sum(stats.samples);
};
var _BrianHicks$elm_benchmark$Benchmark_Reporting$totalOperations = function (stats) {
	return stats.sampleSize * _elm_lang$core$List$length(stats.samples);
};
var _BrianHicks$elm_benchmark$Benchmark_Reporting$mean = function (numbers) {
	return _elm_lang$core$List$sum(numbers) / _elm_lang$core$Basics$toFloat(
		_elm_lang$core$List$length(numbers));
};
var _BrianHicks$elm_benchmark$Benchmark_Reporting$stddev = function (numbers) {
	var thisMean = _BrianHicks$elm_benchmark$Benchmark_Reporting$mean(numbers);
	return _elm_lang$core$Basics$sqrt(
		_BrianHicks$elm_benchmark$Benchmark_Reporting$mean(
			A2(
				_elm_lang$core$List$map,
				function (n) {
					return Math.pow(n - thisMean, 2);
				},
				numbers)));
};
var _BrianHicks$elm_benchmark$Benchmark_Reporting$meanRuntime = function (stats) {
	var mean = _BrianHicks$elm_benchmark$Benchmark_Reporting$totalRuntime(stats) / _elm_lang$core$Basics$toFloat(
		_BrianHicks$elm_benchmark$Benchmark_Reporting$totalOperations(stats));
	var meanStddev = _BrianHicks$elm_benchmark$Benchmark_Reporting$stddev(
		A2(
			_elm_lang$core$List$map,
			function (sample) {
				return sample / _elm_lang$core$Basics$toFloat(stats.sampleSize);
			},
			stats.samples));
	return {ctor: '_Tuple2', _0: mean, _1: meanStddev};
};
var _BrianHicks$elm_benchmark$Benchmark_Reporting$compareMeanRuntime = F2(
	function (a, b) {
		return (_elm_lang$core$Tuple$first(
			_BrianHicks$elm_benchmark$Benchmark_Reporting$meanRuntime(a)) / _elm_lang$core$Tuple$first(
			_BrianHicks$elm_benchmark$Benchmark_Reporting$meanRuntime(b))) - 1;
	});
var _BrianHicks$elm_benchmark$Benchmark_Reporting$operationsPerSecond = function (stats) {
	var opsPerSec = A2(
		_elm_lang$core$List$map,
		function (sample) {
			return _elm_lang$core$Basics$toFloat(stats.sampleSize) * (_elm_lang$core$Time$second / sample);
		},
		stats.samples);
	return {
		ctor: '_Tuple2',
		_0: _BrianHicks$elm_benchmark$Benchmark_Reporting$mean(opsPerSec),
		_1: _BrianHicks$elm_benchmark$Benchmark_Reporting$stddev(opsPerSec)
	};
};
var _BrianHicks$elm_benchmark$Benchmark_Reporting$compareOperationsPerSecond = F2(
	function (a, b) {
		return (_elm_lang$core$Tuple$first(
			_BrianHicks$elm_benchmark$Benchmark_Reporting$operationsPerSecond(a)) / _elm_lang$core$Tuple$first(
			_BrianHicks$elm_benchmark$Benchmark_Reporting$operationsPerSecond(b))) - 1;
	});
var _BrianHicks$elm_benchmark$Benchmark_Reporting$Stats = F2(
	function (a, b) {
		return {sampleSize: a, samples: b};
	});
var _BrianHicks$elm_benchmark$Benchmark_Reporting$stats = _BrianHicks$elm_benchmark$Benchmark_Reporting$Stats;
var _BrianHicks$elm_benchmark$Benchmark_Reporting$Compare = F3(
	function (a, b, c) {
		return {ctor: 'Compare', _0: a, _1: b, _2: c};
	});
var _BrianHicks$elm_benchmark$Benchmark_Reporting$Group = F2(
	function (a, b) {
		return {ctor: 'Group', _0: a, _1: b};
	});
var _BrianHicks$elm_benchmark$Benchmark_Reporting$Benchmark = F2(
	function (a, b) {
		return {ctor: 'Benchmark', _0: a, _1: b};
	});
var _BrianHicks$elm_benchmark$Benchmark_Reporting$Success = function (a) {
	return {ctor: 'Success', _0: a};
};
var _BrianHicks$elm_benchmark$Benchmark_Reporting$Failure = function (a) {
	return {ctor: 'Failure', _0: a};
};
var _BrianHicks$elm_benchmark$Benchmark_Reporting$Pending = F3(
	function (a, b, c) {
		return {ctor: 'Pending', _0: a, _1: b, _2: c};
	});
var _BrianHicks$elm_benchmark$Benchmark_Reporting$ToSize = function (a) {
	return {ctor: 'ToSize', _0: a};
};
var _BrianHicks$elm_benchmark$Benchmark_Reporting$fromBenchmark = function (internal) {
	var fromStatus = function (internal) {
		var _p4 = internal;
		switch (_p4.ctor) {
			case 'ToSize':
				return _BrianHicks$elm_benchmark$Benchmark_Reporting$ToSize(_p4._0);
			case 'Pending':
				return A3(_BrianHicks$elm_benchmark$Benchmark_Reporting$Pending, _p4._0, _p4._1, _p4._2);
			case 'Failure':
				return _BrianHicks$elm_benchmark$Benchmark_Reporting$Failure(_p4._0);
			default:
				return _BrianHicks$elm_benchmark$Benchmark_Reporting$Success(
					A2(_BrianHicks$elm_benchmark$Benchmark_Reporting$stats, _p4._0._0, _p4._0._1));
		}
	};
	var _p5 = internal;
	switch (_p5.ctor) {
		case 'Benchmark':
			return A2(
				_BrianHicks$elm_benchmark$Benchmark_Reporting$Benchmark,
				_p5._0,
				fromStatus(_p5._2));
		case 'Group':
			return A2(
				_BrianHicks$elm_benchmark$Benchmark_Reporting$Group,
				_p5._0,
				A2(_elm_lang$core$List$map, _BrianHicks$elm_benchmark$Benchmark_Reporting$fromBenchmark, _p5._1));
		default:
			return A3(
				_BrianHicks$elm_benchmark$Benchmark_Reporting$Compare,
				_p5._0,
				_BrianHicks$elm_benchmark$Benchmark_Reporting$fromBenchmark(_p5._1),
				_BrianHicks$elm_benchmark$Benchmark_Reporting$fromBenchmark(_p5._2));
	}
};
var _BrianHicks$elm_benchmark$Benchmark_Reporting$version1Decoder = function () {
	var status = function (stage) {
		...
		switch (_p6) {
			case 'toSize':
				return A2(
					_elm_lang$core$Json_Decode$map,
					_BrianHicks$elm_benchmark$Benchmark_Reporting$ToSize,
					A2(_elm_lang$core$Json_Decode$field, 'time', _elm_lang$core$Json_Decode$float));
			case 'pending':
				return A4(
					_elm_lang$core$Json_Decode$map3,
					_BrianHicks$elm_benchmark$Benchmark_Reporting$Pending,
					A2(_elm_lang$core$Json_Decode$field, 'time', _elm_lang$core$Json_Decode$float),
					A2(_elm_lang$core$Json_Decode$field, 'sampleSize', _elm_lang$core$Json_Decode$int),
					A2(
			...
			case 'failure':
				return A2(
					...
					function (message) {
						var _p7 = message;
						if (_p7 === 'stack overflow') {
							return _elm_lang$core$Json_Decode$succeed(
								_BrianHicks$elm_benchmark$Benchmark_Reporting$Failure(_BrianHicks$elm_benchmark$Benchmark_LowLevel$StackOverflow));
						} else {
							return _elm_lang$core$Json_Decode$succeed(
								_BrianHicks$elm_benchmark$Benchmark_Reporting$Failure(
									_BrianHicks$elm_benchmark$Benchmark_LowLevel$UnknownError(message)));
						}
					},
			...
			case 'success':
				return A2(
					_elm_lang$core$Json_Decode$map,
					_BrianHicks$elm_benchmark$Benchmark_Reporting$Success,
					A3(
						_elm_lang$core$Json_Decode$map2,
						_BrianHicks$elm_benchmark$Benchmark_Reporting$stats,
						A2(_elm_lang$core$Json_Decode$field, 'sampleSize', _elm_lang$core$Json_Decode$int),
						A2(
							_elm_lang$core$Json_Decode$field,
							'samples',
			...
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(
						...
						'I don\'t know how to decode the \"',
						A2(_elm_lang$core$Basics_ops['++'], stage, '\" stage')));
		}
	};
	var report = function (kind) {
		var _p8 = kind;
		switch (_p8) {
			case 'benchmark':
				return A3(
					...
					A2(
						...
						A2(
							_elm_lang$core$Json_Decode$andThen,
							status,
							A2(_elm_lang$core$Json_Decode$field, '_stage', _elm_lang$core$Json_Decode$string))));
			case 'compare':
				return A4(
					_elm_lang$core$Json_Decode$map3,
					_BrianHicks$elm_benchmark$Benchmark_Reporting$Compare,
					...
					A2(
						...
						_elm_lang$core$Json_Decode$lazy(
							function (_p9) {
								return _BrianHicks$elm_benchmark$Benchmark_Reporting$version1Decoder;
							})),
					A2(
						_elm_lang$core$Json_Decode$field,
						'b',
			...
			case 'group':
				return A3(
					...
					A2(
						...
						_elm_lang$core$Json_Decode$lazy(
							function (_p11) {
								return _elm_lang$core$Json_Decode$list(_BrianHicks$elm_benchmark$Benchmark_Reporting$version1Decoder);
							})));
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(
						_elm_lang$core$Basics_ops['++'],
						'I don\'t know how to decode a \"',
	...
	return A2(
		_elm_lang$core$Json_Decode$andThen,
		report,
		A2(_elm_lang$core$Json_Decode$field, '_kind', _elm_lang$core$Json_Decode$string));
}();
var _BrianHicks$elm_benchmark$Benchmark_Reporting$decoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (version) {
		var _p12 = version;
		if (_p12 === 1) {
			return A2(_elm_lang$core$Json_Decode$field, 'report', _BrianHicks$elm_benchmark$Benchmark_Reporting$version1Decoder);
		} else {
			return _elm_lang$core$Json_Decode$fail(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'I don\'t know how to decode version',
...
var _user$project$Dict_AVL$height = function (dict) {
	var _p0 = dict;
	if (_p0.ctor === 'Empty') {
		return 0;
	} else {
...
var _user$project$Dict_AVL$heightDiff = function (dict) {
	var _p1 = dict;
	if (_p1.ctor === 'Empty') {
		return 0;
	} else {
		return _user$project$Dict_AVL$height(_p1._4) - _user$project$Dict_AVL$height(_p1._3);
	}
};
var _user$project$Dict_AVL$foldr = F3(
	function (op, acc, dict) {
		foldr:
		while (true) {
			var _p2 = dict;
			if (_p2.ctor === 'Empty') {
				...
				var _v3 = op,
					...
					_p2._1,
					_p2._2,
					A3(_user$project$Dict_AVL$foldr, op, acc, _p2._4)),
					_v5 = _p2._3;
				op = _v3;
				acc = _v4;
				dict = _v5;
...
var _user$project$Dict_AVL$keys = function (dict) {
	return A3(
		_user$project$Dict_AVL$foldr,
		F3(
			function (key, _p3, keyList) {
				return {ctor: '::', _0: key, _1: keyList};
			}),
		{ctor: '[]'},
		dict);
};
var _user$project$Dict_AVL$values = function (dict) {
	return A3(
		_user$project$Dict_AVL$foldr,
		_elm_lang$core$Basics$always(
			F2(
...
var _user$project$Dict_AVL$toList = function (dict) {
	return A3(
		_user$project$Dict_AVL$foldr,
		F3(
			function (key, value, list) {
...
var _user$project$Dict_AVL$foldl = F3(
	function (op, acc, dict) {
		foldl:
		while (true) {
			var _p4 = dict;
			if (_p4.ctor === 'Empty') {
				...
				var _v7 = op,
					...
					_p4._1,
					_p4._2,
					A3(_user$project$Dict_AVL$foldl, op, acc, _p4._3)),
					_v9 = _p4._4;
				op = _v7;
				acc = _v8;
				dict = _v9;
...
var _user$project$Dict_AVL$merge = F6(
	function (leftStep, bothStep, rightStep, leftDict, rightDict, initialResult) {
		var stepState = F3(
			function (rKey, rValue, _p5) {
				stepState:
				while (true) {
					var _p6 = _p5;
					var _p12 = _p6._1;
					...
					if (_p7.ctor === '[]') {
						return {
							ctor: '_Tuple2',
							_0: _p11,
							_1: A3(rightStep, rKey, rValue, _p12)
						};
					} else {
						var _p10 = _p7._1;
						var _p9 = _p7._0._1;
						var _p8 = _p7._0._0;
						if (_elm_lang$core$Native_Utils.cmp(_p8, rKey) < 0) {
							var _v12 = rKey,
								_v13 = rValue,
								_v14 = {
								ctor: '_Tuple2',
								_0: _p10,
								_1: A3(leftStep, _p8, _p9, _p12)
							};
							rKey = _v12;
							rValue = _v13;
							_p5 = _v14;
							...
							if (_elm_lang$core$Native_Utils.cmp(_p8, rKey) > 0) {
								...
								return {
									ctor: '_Tuple2',
									_0: _p10,
									_1: A4(bothStep, _p8, _p9, rValue, _p12)
								};
							}
						}
					}
		...
		var _p13 = A3(
			...
			{
				ctor: '_Tuple2',
				_0: _user$project$Dict_AVL$toList(leftDict),
				_1: initialResult
			},
			rightDict);
		var leftovers = _p13._0;
		var intermediateResult = _p13._1;
		return A3(
			_elm_lang$core$List$foldl,
			F2(
				function (_p14, result) {
					var _p15 = _p14;
					return A3(leftStep, _p15._0, _p15._1, result);
				}),
			intermediateResult,
			leftovers);
	});
var _user$project$Dict_AVL$size = function (dict) {
	return A3(
		_user$project$Dict_AVL$foldl,
		F3(
			function (_p17, _p16, acc) {
				return acc + 1;
			}),
		0,
		dict);
	...
	function (key, dict) {
		...
		while (true) {
			...
			if (_p18.ctor === 'Empty') {
				...
				var _p19 = A2(_elm_lang$core$Basics$compare, key, _p18._1);
				switch (_p19.ctor) {
					case 'EQ':
						return _elm_lang$core$Maybe$Just(_p18._2);
					case 'LT':
						var _v18 = key,
							_v19 = _p18._3;
						key = _v18;
...
var _user$project$Dict_AVL$member = F2(
	function (key, dict) {
		return !_elm_lang$core$Native_Utils.eq(
			A2(_user$project$Dict_AVL$get, key, dict),
			_elm_lang$core$Maybe$Nothing);
	});
var _user$project$Dict_AVL$Node = F5(
	function (a, b, c, d, e) {
		return {ctor: 'Node', _0: a, _1: b, _2: c, _3: d, _4: e};
	});
var _user$project$Dict_AVL$build = F4(
	function (key, value, left, right) {
		return A5(
			_user$project$Dict_AVL$Node,
			A2(
				_elm_lang$core$Basics$max,
				_user$project$Dict_AVL$height(left),
				_user$project$Dict_AVL$height(right)) + 1,
			key,
			value,
			left,
			right);
	});
var _user$project$Dict_AVL$rotateLeft = function (dict) {
	var _p20 = dict;
	if ((_p20.ctor === 'Node') && (_p20._4.ctor === 'Node')) {
		return A4(
			_user$project$Dict_AVL$build,
			_p20._4._1,
			_p20._4._2,
			A4(_user$project$Dict_AVL$build, _p20._1, _p20._2, _p20._3, _p20._4._3),
			_p20._4._4);
	} else {
		return dict;
	}
};
var _user$project$Dict_AVL$rotateRight = function (dict) {
	var _p21 = dict;
	if ((_p21.ctor === 'Node') && (_p21._3.ctor === 'Node')) {
		return A4(
			_user$project$Dict_AVL$build,
			_p21._3._1,
			_p21._3._2,
			_p21._3._3,
			A4(_user$project$Dict_AVL$build, _p21._1, _p21._2, _p21._3._4, _p21._4));
	} else {
		return dict;
	}
};
var _user$project$Dict_AVL$balance = function (dict) {
	var _p22 = dict;
	if (_p22.ctor === 'Empty') {
		return dict;
	} else {
		...
		var _p24 = _p22._3;
		var _p23 = _p22._1;
		var setDiff = _user$project$Dict_AVL$heightDiff(dict);
		return _elm_lang$core$Native_Utils.eq(setDiff, -2) ? (_elm_lang$core$Native_Utils.eq(
			_user$project$Dict_AVL$heightDiff(_p24),
			1) ? _user$project$Dict_AVL$rotateRight(
			A5(
				_user$project$Dict_AVL$Node,
				_p25,
				_p23,
				_p27,
				_user$project$Dict_AVL$rotateLeft(_p24),
				_p26)) : _user$project$Dict_AVL$rotateRight(dict)) : (_elm_lang$core$Native_Utils.eq(setDiff, 2) ? (_elm_lang$core$Native_Utils.eq(
			_user$project$Dict_AVL$heightDiff(_p26),
			-1) ? _user$project$Dict_AVL$rotateLeft(
			A5(
				_user$project$Dict_AVL$Node,
				_p25,
				_p23,
				_p27,
				_p24,
				_user$project$Dict_AVL$rotateRight(_p26))) : _user$project$Dict_AVL$rotateLeft(dict)) : dict);
	}
};
var _user$project$Dict_AVL$Empty = {ctor: 'Empty'};
var _user$project$Dict_AVL$empty = _user$project$Dict_AVL$Empty;
var _user$project$Dict_AVL$isEmpty = function (dict) {
	return _elm_lang$core$Native_Utils.eq(dict, _user$project$Dict_AVL$empty);
};
var _user$project$Dict_AVL$singleton = F2(
	function (key, val) {
...
var _user$project$Dict_AVL$NeedRebalance = function (a) {
	return {ctor: 'NeedRebalance', _0: a};
};
var _user$project$Dict_AVL$update = F3(
	function (key, alter, dict) {
		var getSmallest = function (dict) {
			getSmallest:
			while (true) {
				var _p28 = dict;
				if (_p28.ctor === 'Empty') {
					...
					if (_p28._3.ctor === 'Empty') {
						return {ctor: '_Tuple2', _0: _p28._1, _1: _p28._2};
					} else {
						var _v26 = _p28._3;
						dict = _v26;
		...
		var up = F3(
			function (key, alter, dict) {
				var _p30 = dict;
				if (_p30.ctor === 'Empty') {
					var _p31 = alter(_elm_lang$core$Maybe$Nothing);
					if (_p31.ctor === 'Nothing') {
						return _user$project$Dict_AVL$NoOp;
					} else {
						return _user$project$Dict_AVL$NeedRebalance(
							A2(_user$project$Dict_AVL$singleton, key, _p31._0));
					}
				} else {
					var _p44 = _p30._2;
					var _p43 = _p30._4;
					...
					var _p41 = _p30._3;
					var _p40 = _p30._1;
					var _p32 = A2(_elm_lang$core$Basics$compare, key, _p40);
					switch (_p32.ctor) {
						case 'LT':
							var _p33 = A3(up, key, alter, _p41);
							switch (_p33.ctor) {
								case 'NoNeed':
									return _user$project$Dict_AVL$NoNeed(
										A5(_user$project$Dict_AVL$Node, _p42, _p40, _p44, _p33._0, _p43));
								case 'NeedRebalance':
									return _user$project$Dict_AVL$NeedRebalance(
										_user$project$Dict_AVL$balance(
											A4(_user$project$Dict_AVL$build, _p40, _p44, _p33._0, _p43)));
								default:
									return _user$project$Dict_AVL$NoOp;
							}
						case 'EQ':
							...
							if (_p34.ctor === 'Nothing') {
								var _p35 = {ctor: '_Tuple2', _0: _p41, _1: _p43};
								if (_p35._0.ctor === 'Empty') {
									return _user$project$Dict_AVL$NeedRebalance(_p43);
								} else {
									if (_p35._1.ctor === 'Empty') {
										return _user$project$Dict_AVL$NeedRebalance(_p41);
									} else {
										var _p36 = getSmallest(_p43);
										var skey = _p36._0;
										var sval = _p36._1;
										var removeNext = A3(
											up,
										...
										switch (_p37.ctor) {
											case 'NoNeed':
												return _user$project$Dict_AVL$NoNeed(
													A4(_user$project$Dict_AVL$build, skey, sval, _p41, _p37._0));
											case 'NeedRebalance':
												return _user$project$Dict_AVL$NeedRebalance(
													_user$project$Dict_AVL$balance(
														A4(_user$project$Dict_AVL$build, skey, sval, _p41, _p37._0)));
								...
								var _p38 = _p34._0;
								return _elm_lang$core$Native_Utils.eq(_p38, _p44) ? _user$project$Dict_AVL$NoOp : _user$project$Dict_AVL$NoNeed(
									A5(_user$project$Dict_AVL$Node, _p42, key, _p38, _p41, _p43));
							}
						default:
							var _p39 = A3(up, key, alter, _p43);
							switch (_p39.ctor) {
								case 'NoNeed':
									return _user$project$Dict_AVL$NoNeed(
										A5(_user$project$Dict_AVL$Node, _p42, _p40, _p44, _p41, _p39._0));
								case 'NeedRebalance':
									return _user$project$Dict_AVL$NeedRebalance(
										_user$project$Dict_AVL$balance(
											A4(_user$project$Dict_AVL$build, _p40, _p44, _p41, _p39._0)));
								default:
									return _user$project$Dict_AVL$NoOp;
							}
					}
...
var _user$project$Dict_AVL$union = F2(
	function (left, right) {
...
var _user$project$Dict_AVL$filter = function (predicate) {
	return A2(
		...
		F2(
			function (k, v) {
				return A2(predicate, k, v) ? A2(_user$project$Dict_AVL$insert, k, v) : _elm_lang$core$Basics$identity;
			}),
		_user$project$Dict_AVL$empty);
};
var _user$project$Dict_AVL$intersect = F2(
	function (t1, t2) {
		return A2(
...
var _user$project$Dict_AVL$diff = F2(
	function (t1, t2) {
		return A2(
			_user$project$Dict_AVL$filter,
			F2(
...
var _user$project$Dict_AVL$partition = function (predicate) {
	return A2(
		_user$project$Dict_AVL$foldl,
		F2(
			function (k, v) {
				return A2(predicate, k, v) ? _elm_lang$core$Tuple$mapFirst(
					A2(_user$project$Dict_AVL$insert, k, v)) : _elm_lang$core$Tuple$mapSecond(
					A2(_user$project$Dict_AVL$insert, k, v));
			}),
		{ctor: '_Tuple2', _0: _user$project$Dict_AVL$empty, _1: _user$project$Dict_AVL$empty});
};
var _user$project$Dict_AVL$remove = F2(
	function (key, dict) {
		return A3(
			_user$project$Dict_AVL$update,
			key,
...
var _user$project$Dict_AVL$fromList = function (assocs) {
	return A3(
		_elm_lang$core$List$foldl,
		F2(
			function (_p50, dict) {
...
var _user$project$Random_Deletion$listOfSize = F2(
	function (seed, size) {
		return _elm_lang$core$Tuple$first(
			A2(
				_mgold$elm_random_pcg$Random_Pcg$step,
				A2(
					...
					size,
					A2(_mgold$elm_random_pcg$Random_Pcg$int, 0, 3 * size)),
				seed));
	});
var _user$project$Random_Deletion$_p0 = A2(
	_mgold$elm_random_pcg$Random_Pcg$step,
	_mgold$elm_random_pcg$Random_Pcg$independentSeed,
	_mgold$elm_random_pcg$Random_Pcg$initialSeed(227852860));
var _user$project$Random_Deletion$seed = _user$project$Random_Deletion$_p0._0;
var _user$project$Random_Deletion$otherSeed = _user$project$Random_Deletion$_p0._1;
var _user$project$Random_Deletion$forValues = F3(
	function (name, size, keyer) {
		var toRemove = A2(
			_elm_lang$core$List$map,
			keyer,
			A2(_user$project$Random_Deletion$listOfSize, _user$project$Random_Deletion$otherSeed, size));
		var source = A2(
			_elm_lang$core$List$map,
			function (n) {
				return {
		...
		return A3(
			...
			A4(
				...
				'Dict',
				_elm_lang$core$List$foldl(_elm_lang$core$Dict$remove),
				_elm_lang$core$Dict$fromList(source),
				toRemove),
			A4(
				_BrianHicks$elm_benchmark$Benchmark$benchmark2,
				'Dict.AVL',
				_elm_lang$core$List$foldl(_user$project$Dict_AVL$remove),
...
var _user$project$Random_Deletion$suiteOfSize = function (size) {
	return A2(
		...
		_elm_lang$core$Basics$toString(size),
		{
			...
			_1: {
				ctor: '::',
				_0: A3(_user$project$Random_Deletion$forValues, 'int', size, _elm_lang$core$Basics$identity),
				_1: {
					ctor: '::',
					_0: A3(_user$project$Random_Deletion$forValues, 'float', size, _elm_lang$core$Basics$toFloat),
					_1: {
						ctor: '::',
						_0: A3(
							_user$project$Random_Deletion$forValues,
							'time',
							size,
							function (_p1) {
								return A2(
						...
						_1: {
							ctor: '::',
							_0: A3(_user$project$Random_Deletion$forValues, 'char', size, _elm_lang$core$Char$fromCode),
							_1: {
								ctor: '::',
								_0: A3(
									_user$project$Random_Deletion$forValues,
...
var _user$project$Random_Insertion$seed = _mgold$elm_random_pcg$Random_Pcg$initialSeed(227852860);
var _user$project$Random_Insertion$forValues = F3(
	function (name, size, keyer) {
		var source = A2(
			_elm_lang$core$List$map,
			A2(
...
var _user$project$Random_Insertion$suiteOfSize = function (size) {
	return A2(
		...
		_elm_lang$core$Basics$toString(size),
		{
			...
			_1: {
				ctor: '::',
				_0: A3(_user$project$Random_Insertion$forValues, 'int', size, _elm_lang$core$Basics$identity),
				_1: {
					ctor: '::',
					_0: A3(_user$project$Random_Insertion$forValues, 'float', size, _elm_lang$core$Basics$toFloat),
					_1: {
						ctor: '::',
						_0: A3(
							_user$project$Random_Insertion$forValues,
							'time',
							size,
							function (_p0) {
								return A2(
						...
						_1: {
							ctor: '::',
							_0: A3(_user$project$Random_Insertion$forValues, 'char', size, _elm_lang$core$Char$fromCode),
							_1: {
								ctor: '::',
								_0: A3(
									_user$project$Random_Insertion$forValues,
...
var _user$project$Serial_Deletion$suiteOfSize = function (size) {
	return A2(
		...
		_elm_lang$core$Basics$toString(size),
		{
			...
			_1: {
				ctor: '::',
				_0: A3(_user$project$Serial_Deletion$forValues, 'int', size, _elm_lang$core$Basics$identity),
				_1: {
					ctor: '::',
					_0: A3(_user$project$Serial_Deletion$forValues, 'float', size, _elm_lang$core$Basics$toFloat),
					_1: {
						ctor: '::',
						_0: A3(
							_user$project$Serial_Deletion$forValues,
							'time',
							size,
							function (_p0) {
								return A2(
						...
						_1: {
							ctor: '::',
							_0: A3(_user$project$Serial_Deletion$forValues, 'char', size, _elm_lang$core$Char$fromCode),
							_1: {
								ctor: '::',
								_0: A3(
									_user$project$Serial_Deletion$forValues,
...
var _user$project$Serial_Insertion$suiteOfSize = function (size) {
	return A2(
		...
		_elm_lang$core$Basics$toString(size),
		{
			...
			_1: {
				ctor: '::',
				_0: A3(_user$project$Serial_Insertion$forValues, 'int', size, _elm_lang$core$Basics$identity),
				_1: {
					ctor: '::',
					_0: A3(_user$project$Serial_Insertion$forValues, 'float', size, _elm_lang$core$Basics$toFloat),
					_1: {
						ctor: '::',
						_0: A3(
							_user$project$Serial_Insertion$forValues,
							'time',
							size,
							function (_p0) {
								return A2(
						...
						_1: {
							ctor: '::',
							_0: A3(_user$project$Serial_Insertion$forValues, 'char', size, _elm_lang$core$Char$fromCode),
							_1: {
								ctor: '::',
								_0: A3(
									_user$project$Serial_Insertion$forValues,
				...
				F2(
					function (list, dict) {
						return A2(
							_elm_lang$core$List$map,
							function (x) {
								return A2(_user$project$Dict_AVL$get, x, dict);
							},
							list);
					}),
				keys,
...
var _user$project$Serial_Retrieval$suiteOfSize = function (size) {
	return A2(
		...
		_elm_lang$core$Basics$toString(size),
		{
			...
			_1: {
				ctor: '::',
				_0: A3(_user$project$Serial_Retrieval$forValues, 'int', size, _elm_lang$core$Basics$identity),
				_1: {
					ctor: '::',
					_0: A3(_user$project$Serial_Retrieval$forValues, 'float', size, _elm_lang$core$Basics$toFloat),
					_1: {
						ctor: '::',
						_0: A3(
							_user$project$Serial_Retrieval$forValues,
							'time',
							size,
							function (_p0) {
								return A2(
						...
						_1: {
							ctor: '::',
							_0: A3(_user$project$Serial_Retrieval$forValues, 'char', size, _elm_lang$core$Char$fromCode),
							_1: {
								ctor: '::',
								_0: A3(
									_user$project$Serial_Retrieval$forValues,
...
var _user$project$Main$descriptorToString = function (benchmarkDescriptor) {
	return A2(
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			' of size ',
			_elm_lang$core$Basics$toString(benchmarkDescriptor.size)));
};
var _user$project$Main$renderDescriptor = function (benchmarkDescriptor) {
	return _elm_lang$html$Html$text(
		_user$project$Main$descriptorToString(benchmarkDescriptor));
};
var _user$project$Main$renderNext = function (benchmarkDescriptorList) {
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						ctor: '::',
						_0: function () {
							var _p0 = benchmarkDescriptorList;
							if (_p0.ctor === '[]') {
								return _elm_lang$html$Html$text('No more benchmarks queued!');
							} else {
								return A2(
									_elm_lang$html$Html$div,
									{ctor: '[]'},
											...
											_0: A2(
												_elm_lang$html$Html$ul,
												{
													...
													_0: _elm_lang$html$Html_Attributes$style(
														{
															ctor: '::',
															_0: {ctor: '_Tuple2', _0: 'column-count', _1: '3'},
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												},
												A2(
													...
													function (descriptor) {
														return A2(
															...
															{
																ctor: '::',
																_0: _user$project$Main$renderDescriptor(descriptor),
																_1: {ctor: '[]'}
															});
													},
...
var _user$project$Main$encodeBrowserInfo = function (browserInfo) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'browser',
				_1: _elm_lang$core$Json_Encode$string(browserInfo.name)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'version',
					_1: _elm_lang$core$Json_Encode$string(browserInfo.version)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'os',
						_1: _elm_lang$core$Json_Encode$string(browserInfo.os)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'osVersion',
							_1: _elm_lang$core$Json_Encode$string(browserInfo.osVersion)
						},
						_1: {ctor: '[]'}
					}
				}
		...
		return _elm_lang$core$Json_Encode$object(
			{
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'browserInfo',
					_1: _user$project$Main$encodeBrowserInfo(browserInfo)
				},
				_1: {
					ctor: '::',
					_0: {
...
var _user$project$Main$updateBrowserInfo = F2(
	function (msg, browserInfo) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'UpdateBrowser':
				return _elm_lang$core$Native_Utils.update(
...
var _user$project$Main$applyList = F2(
	function (fList, argList) {
		return _elm_lang$core$List$concat(
			A2(
				_elm_lang$core$List$map,
				function (f) {
					return A2(_elm_lang$core$List$map, f, argList);
				},
				fList));
	});
var _user$project$Main$allBenches = function () {
	...
	var benchFactories = _elm_lang$core$Dict$fromList(
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'serial insertion', _1: _user$project$Serial_Insertion$suiteOfSize},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'serial deletion', _1: _user$project$Serial_Deletion$suiteOfSize},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'serial retrieval', _1: _user$project$Serial_Retrieval$suiteOfSize},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'random deletion', _1: _user$project$Random_Deletion$suiteOfSize},
						_1: {
							ctor: '::',
	...
	var descriptorFactory = F2(
		function (_p2, size) {
			var _p3 = _p2;
			return {
				name: _p3._0,
				size: size,
				benchmark: _p3._1(size)
			};
		});
	return A2(
		_elm_lang$core$List$map,
		function (descriptor) {
			return _elm_lang$core$Native_Utils.update(
				descriptor,
				{
					benchmark: A2(_BrianHicks$elm_benchmark$Benchmark$withRuntime, 1 * _elm_lang$core$Time$second, descriptor.benchmark)
				});
		},
		A2(
			_user$project$Main$applyList,
			A2(
				_elm_lang$core$List$map,
				descriptorFactory,
				_elm_lang$core$Dict$toList(benchFactories)),
			sizes));
}();
var _user$project$Main$breakForRender = function (task) {
	return A2(
		_elm_lang$core$Task$andThen,
		function (_p4) {
			return task;
...
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {currentBenchmark: a, browserInfo: b, toRun: c, runPhase: d, failedRequests: e};
	});
var _user$project$Main$BenchmarkDescriptor = F3(
	function (a, b, c) {
...
var _user$project$Main$BrowserInfo = F4(
	function (a, b, c, d) {
...
var _user$project$Main$UpdateBrowserInfo = function (a) {
	return {ctor: 'UpdateBrowserInfo', _0: a};
};
var _user$project$Main$Retry = function (a) {
	return {ctor: 'Retry', _0: a};
};
var _user$project$Main$renderFailed = F2(
	function (phase, submissionList) {
		var button = function (submission) {
			var _p5 = phase;
			if (_p5.ctor === 'Finished') {
				return {
					ctor: '::',
					_0: A2(
									...
									_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
										{
											...
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$Main$Retry(submission)),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Retry'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				};
		...
		var description = function () {
			...
			if (_p6.ctor === 'Finished') {
				return 'Alright, done running benchmarks. You can now attempt to retry submission...';
			} else {
				return 'I failed to submit some benchmarks. Let\'s wait for the other benchmarks to finish, and then you can retry them once you have access to the internet again.';
			}
		}();
		var _p7 = submissionList;
		if (_p7.ctor === '[]') {
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
			...
			return _rundis$elm_bootstrap$Bootstrap_Card$view(
				A3(
										...
										A2(
											...
											function (submission) {
												return A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text(submission.description),
														_1: button(submission)
													});
											},
											submissionList)),
									_1: {ctor: '[]'}
					...
					_rundis$elm_bootstrap$Bootstrap_Card$config(
						{
							ctor: '::',
							_0: _rundis$elm_bootstrap$Bootstrap_Card$warning,
							_1: {ctor: '[]'}
						})));
		}
	});
var _user$project$Main$Start = {ctor: 'Start'};
var _user$project$Main$ReSubmissionResult = function (a) {
	return {ctor: 'ReSubmissionResult', _0: a};
};
var _user$project$Main$retry = function (submission) {
	return A2(
		_elm_lang$http$Http$send,
		function (_p8) {
			return _user$project$Main$ReSubmissionResult(
				A4(_user$project$Main$Submission, submission.description, submission.tries + 1, submission.request, _p8));
		},
		submission.request);
};
var _user$project$Main$SubmissionResult = function (a) {
	return {ctor: 'SubmissionResult', _0: a};
};
	...
	function (browserInfo, descriptor) {
		...
		return function (request) {
			return A2(
				_elm_lang$http$Http$send,
				function (_p9) {
					return _user$project$Main$SubmissionResult(
						A4(
							_user$project$Main$Submission,
							_user$project$Main$descriptorToString(descriptor),
							0,
							request,
							_p9));
				},
			...
			A3(_elm_lang$http$Http$post, 'https://elm-bench.herokuapp.com/', body, _elm_lang$core$Json_Decode$string));
	});
var _user$project$Main$Update = function (a) {
	return {ctor: 'Update', _0: a};
};
var _user$project$Main$next = function (descriptor) {
	return A2(
		_elm_lang$core$Maybe$map,
		_elm_lang$core$Task$perform(
			function (bench) {
		...
		A2(
			_elm_lang$core$Maybe$map,
			_user$project$Main$breakForRender,
			_BrianHicks$elm_benchmark$Benchmark$step(descriptor.benchmark)));
};
			...
			switch (_p10.ctor) {
				case 'Retry':
					...
					return A2(
						...
						{
							ctor: '::',
							_0: _user$project$Main$retry(_p11),
							_1: {ctor: '[]'}
						});
				case 'Update':
					var _p13 = _p10._0;
					var _p12 = _user$project$Main$next(_p13);
					if (_p12.ctor === 'Just') {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{
									currentBenchmark: _elm_lang$core$Maybe$Just(_p13)
								}),
							{
								ctor: '::',
								_0: _p12._0,
						...
						return A2(
							...
							{
								ctor: '::',
								_0: A2(_user$project$Main$submitBench, model.browserInfo, _p13),
								_1: {ctor: '[]'}
							});
					}
				case 'ReSubmissionResult':
					var _p14 = _p10._0.result;
					if (_p14.ctor === 'Err') {
						var _p15 = A2(_elm_lang$core$Debug$log, 'failed', _p14._0);
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{
									failedRequests: {ctor: '::', _0: _p10._0, _1: model.failedRequests}
								}),
							{ctor: '[]'});
					} else {
						return A2(
				...
				case 'SubmissionResult':
					var _p16 = _p10._0.result;
					if (_p16.ctor === 'Err') {
						var _p17 = A2(_elm_lang$core$Debug$log, 'failed', _p16._0);
						var _v10 = _user$project$Main$Start,
						...
						var _v12 = _user$project$Main$Start,
							_v13 = model;
						msg = _v12;
						model = _v13;
						continue update;
				...
				case 'Start':
					var _p18 = model.toRun;
					if (_p18.ctor === '[]') {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{runPhase: _user$project$Main$Finished}),
							{ctor: '[]'});
					} else {
						var _p19 = _p18._0;
						var newModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								currentBenchmark: _elm_lang$core$Maybe$Just(_p19),
								toRun: _p18._1,
								runPhase: _user$project$Main$InProgress
							});
						var _v15 = _user$project$Main$Update(_p19),
							_v16 = newModel;
						msg = _v15;
						model = _v16;
						continue update;
				...
				default:
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								browserInfo: A2(_user$project$Main$updateBrowserInfo, _p10._0, model.browserInfo)
							}),
						{ctor: '[]'});
			}
		}
	});
var _user$project$Main$UpdateOSVersion = function (a) {
	return {ctor: 'UpdateOSVersion', _0: a};
};
var _user$project$Main$UpdateOS = function (a) {
	return {ctor: 'UpdateOS', _0: a};
};
var _user$project$Main$UpdateVersion = function (a) {
	return {ctor: 'UpdateVersion', _0: a};
};
var _user$project$Main$UpdateBrowser = function (a) {
	return {ctor: 'UpdateBrowser', _0: a};
};
var _user$project$Main$renderBrowserForm = F2(
	function (phase, browserInfo) {
		var _p20 = phase;
		if (_p20.ctor === 'Prepare') {
			var myForm = A2(
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Please adjust settings as required, and hit the button to start the benchmark. Note that the benchmarks might run for quite a while...'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											_rundis$elm_bootstrap$Bootstrap_Form$colLabel,
											{
												...
												_1: {
													...
													_0: _rundis$elm_bootstrap$Bootstrap_Grid_Col$attrs(
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$for('browser'),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Browser'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												},
												{
													...
													_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$text(
														{
															ctor: '::',
															_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$value(browserInfo.name),
															_1: {
																ctor: '::',
																_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$id('browser'),
																_1: {
																	ctor: '::',
																	_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$onInput(
																		function (_p21) {
																			return _user$project$Main$UpdateBrowserInfo(
																				_user$project$Main$UpdateBrowser(_p21));
																		}),
																	_1: {ctor: '[]'}
																}
															}
													...
													_rundis$elm_bootstrap$Bootstrap_Form$colLabel,
													{
														...
														_1: {
															...
															_0: _rundis$elm_bootstrap$Bootstrap_Grid_Col$attrs(
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$for('version'),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
														}
													...
													_0: A2(
														...
														},
														{
															...
															_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$text(
																{
																	ctor: '::',
																	_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$value(browserInfo.version),
																	_1: {
																		ctor: '::',
																		_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$id('version'),
																		_1: {
																			ctor: '::',
																			_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$onInput(
																				function (_p22) {
																					return _user$project$Main$UpdateBrowserInfo(
																						_user$project$Main$UpdateVersion(_p22));
																				}),
																			_1: {ctor: '[]'}
																		}
																	}
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												_rundis$elm_bootstrap$Bootstrap_Form$colLabel,
												{
													...
													_1: {
														...
														_0: _rundis$elm_bootstrap$Bootstrap_Grid_Col$attrs(
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$for('os'),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('OS'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(
													...
													},
													{
														...
														_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$text(
															{
																ctor: '::',
																_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$value(browserInfo.os),
																_1: {
																	ctor: '::',
																	_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$id('os'),
																	_1: {
																		ctor: '::',
																		_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$onInput(
																			function (_p23) {
																				return _user$project$Main$UpdateBrowserInfo(
																					_user$project$Main$UpdateOS(_p23));
																			}),
																		_1: {ctor: '[]'}
																	}
																}
														...
														_rundis$elm_bootstrap$Bootstrap_Form$colLabel,
														{
															...
															_1: {
																...
																_0: _rundis$elm_bootstrap$Bootstrap_Grid_Col$attrs(
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$for('osversion'),
																		_1: {ctor: '[]'}
																	}),
																_1: {ctor: '[]'}
															}
														...
														_0: A2(
															...
															},
															{
																...
																_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$text(
																	{
																		ctor: '::',
																		_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$value(browserInfo.osVersion),
																		_1: {
																			ctor: '::',
																			_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$id('osversion'),
																			_1: {
																				ctor: '::',
																				_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$onInput(
																					function (_p24) {
																						return _user$project$Main$UpdateBrowserInfo(
																							_user$project$Main$UpdateOSVersion(_p24));
																					}),
																				_1: {ctor: '[]'}
																			}
																		}
												...
												_0: A2(
													...
													},
													{
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('Start benching'),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}),
											...
											_0: A2(
												...
												{ctor: '[]'},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('I\'m only asking for this information so that I know how the dict is performing on any given platform. If I note a serious regression on any given platform, that\'ll help me pin down the problem, and possibly optimize it away.'),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}),
				...
				A3(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Alright, gotcha. Running the benchmarks now!'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					},
					_rundis$elm_bootstrap$Bootstrap_Card$config(
						{
							ctor: '::',
							_0: _rundis$elm_bootstrap$Bootstrap_Card$info,
							_1: {ctor: '[]'}
						})));
		}
	});
...
var _user$project$Main$Running = F2(
	function (a, b) {
		return {ctor: 'Running', _0: a, _1: b};
	});
var _user$project$Main$Sizing = {ctor: 'Sizing'};
var _user$project$Main$combineState = F2(
	function (left, right) {
		...
		do {
			switch (_p25._1.ctor) {
				case 'Sizing':
					return _user$project$Main$Sizing;
				case 'Running':
					switch (_p25._0.ctor) {
						case 'Sizing':
							break _v18_1;
						case 'Running':
							return A2(_user$project$Main$Running, _p25._0._0 + _p25._1._0, _p25._0._1 + _p25._1._1);
						default:
							var _p27 = _p25._1._1;
							return A2(_user$project$Main$Running, _p25._1._0 + _p27, _p25._0._0 + _p27);
					}
				default:
					switch (_p25._0.ctor) {
						case 'Sizing':
						...
						case 'Running':
							var _p26 = _p25._1._0;
							return A2(_user$project$Main$Running, _p25._0._0 + _p26, _p25._0._1 + _p26);
						default:
							return _user$project$Main$Done(_p25._0._0 + _p25._1._0);
					}
			}
		} while(false);
		return _user$project$Main$Sizing;
	});
var _user$project$Main$state = function (report) {
	var _p28 = report;
	switch (_p28.ctor) {
		case 'Benchmark':
			var _p29 = _p28._1;
			switch (_p29.ctor) {
				case 'Pending':
					return A2(
						_user$project$Main$Running,
						_elm_lang$core$Basics$round(
							_elm_lang$core$List$sum(_p29._2)),
						_elm_lang$core$Basics$round(_p29._0));
				case 'ToSize':
					return _user$project$Main$Sizing;
				case 'Failure':
					return _user$project$Main$Done(0);
				default:
					return _user$project$Main$Done(
						_elm_lang$core$Basics$round(
							_elm_lang$core$List$sum(_p29._0.samples)));
			}
		case 'Group':
			return A3(
				_elm_lang$core$List$foldl,
				_user$project$Main$combineState,
				_user$project$Main$Done(0),
				A2(_elm_lang$core$List$map, _user$project$Main$state, _p28._1));
		default:
			return A2(
				_user$project$Main$combineState,
				_user$project$Main$state(_p28._1),
				_user$project$Main$state(_p28._2));
	}
};
var _user$project$Main$renderRunningBenchmark = function (benchmark) {
	var _p30 = _user$project$Main$state(
		_BrianHicks$elm_benchmark$Benchmark_Reporting$fromBenchmark(benchmark));
	switch (_p30.ctor) {
		case 'Sizing':
			return _elm_lang$html$Html$text('Figuring out how many iterations I should do...');
		case 'Running':
			return _rundis$elm_bootstrap$Bootstrap_Progress$progress(
				{
					ctor: '::',
					_0: _rundis$elm_bootstrap$Bootstrap_Progress$value(((_p30._0 * 100) / _p30._1) | 0),
					_1: {ctor: '[]'}
				});
		default:
			return _elm_lang$html$Html$text('Submitting benchmark...');
	}
};
var _user$project$Main$renderCurrent = function (benchmarkDescriptorMaybe) {
	var _p31 = benchmarkDescriptorMaybe;
	if (_p31.ctor === 'Nothing') {
		return _rundis$elm_bootstrap$Bootstrap_Card$view(
			A3(
				_rundis$elm_bootstrap$Bootstrap_Card$block,
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('No benchmark currently running...'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				},
			...
			A3(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Current benchmark: '),
							_1: {
								ctor: '::',
								_0: _user$project$Main$renderDescriptor(_p32),
								_1: {
									ctor: '::',
									_0: A2(
									...
									_1: {
										ctor: '::',
										_0: _user$project$Main$renderRunningBenchmark(_p32.benchmark),
										_1: {ctor: '[]'}
									}
								}
							}
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Dict vs Dict.AVL benchmarks'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: A3(_elm_lang$html$Html_Lazy$lazy2, _user$project$Main$renderBrowserForm, model.runPhase, model.browserInfo),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: A3(_elm_lang$html$Html_Lazy$lazy2, _user$project$Main$renderFailed, model.runPhase, model.failedRequests),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: A2(_elm_lang$html$Html_Lazy$lazy, _user$project$Main$renderCurrent, model.currentBenchmark),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: A2(_elm_lang$html$Html_Lazy$lazy, _user$project$Main$renderNext, model.toRun),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
